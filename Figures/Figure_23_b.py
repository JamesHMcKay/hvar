...
cmb_instr='../Figures/data/Figure_23_b_chi2.txt'
...
cmb2_instr='../Figures/data/Figure_23_b.txt'
...
CSl2 = m.contour(x,y,cmb2_hdatt,levels,linewidths=1,colors='k')
...
cmbfig.savefig('../Figures/Figures/Figure_23_b.eps',dpi=600)
