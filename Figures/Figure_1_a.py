...
A=np.genfromtxt('../Figures/data/Figure_1_a.txt',usecols=[0,1,2,3])
r2_p=A[0:10,0]
Del_H_p=-A[0:10,1]
sig_r2_p=A[0:10,2]
...
B=np.genfromtxt('../Figures/data/Figure_1_a_details.txt',usecols=[0,1])
b=B[:,0]
a=B[:,1]
...
plt.savefig("../Figures/Figures/Figure_1_a.eps")
