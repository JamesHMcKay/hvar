...
cmb_instr='../Figures/data/Figure_7_a_chi.txt'
cmb_hdat = loadtxt(cmb_instr)
cmb_hdat=array([float(s) for s in cmb_hdat[:,2]])

bdata='../Figures/data/Figure_7_a_fp.txt'
...
#cmbx, cmby = m(360-58.3,21.4) 
cmbx, cmby= m(360-59.3,16.6)
#p3=m.plot(cmbx,cmby,'kx',markersize=15)
...
cmbfig.savefig('../Figures/Figures/Figure_7_a.eps',dpi=600)
