...
A=np.genfromtxt('../Figures/data/Figure_1_b.txt',usecols=[0,1,2,3])
r2_p=A[0:8,0]
Del_H_p=-A[0:8,1]
sig_r2_p=A[0:8,2]
sig_Del_H_p=A[0:8,3]
...
B=np.genfromtxt('../Figures/data/Figure_1_b_details.txt',usecols=[0,1])
b=B[:,0]
a=B[:,1]
...
plt.savefig("../Figures/Figures/Figure_1_b.eps")
