...
ofstream myfile;
myfile.open ("../Figures/data/Figure_1_a.txt");
for (int i=0;i<nb*2;i++)
{
...
ofstream myfile2;
myfile2.open ("../Figures/data/Figure_1_a_details.txt");
Boost_offset boost_offset(0); // use 0 for making plots since we want A model independent not v
...
system("python ../Figures/Figure_1_a.py");
