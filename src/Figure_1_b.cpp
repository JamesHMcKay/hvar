...
int nb=8; // define number of shells we want
...
ofstream myfile;
myfile.open ("../Figures/data/Figure_1_b.txt");
for (int i=0;i<nb*2;i++)
{
...
ofstream myfile2;
myfile2.open ("../Figures/data/Figure_1_b_details.txt");
...
system("python ../Figures/Figure_1_b.py");
